...
public class OrderMultiInfo  implements Serializable {
  ...
  **/
  ...
  public OrderMultiInfo published(Boolean published) {
   ...
   * @return published
  **/
  @ApiModelProperty(value = "true 是发布了，否则为没有发布")
  ...
  **/
  ...
  public OrderMultiInfo extraInfo(String extraInfo) {
   ...
   /**
   * 根据不同的type有不同的extra_info，如果是 size 则没有，如果是 photo那么就是一个List<String>的json串
   * @return extraInfo
  **/
  @ApiModelProperty(value = "根据不同的type有不同的extra_info，如果是 size 则没有，如果是 photo那么就是一个List<String>的json串")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, orderMultiInfo.id) &&
        ...
        Objects.equals(this.published, orderMultiInfo.published) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, orderId, createTime, updateTime, published, type, content, extraInfo);
  }
