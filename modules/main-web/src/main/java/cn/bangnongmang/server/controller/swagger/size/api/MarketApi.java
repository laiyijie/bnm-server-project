package cn.bangnongmang.server.controller.swagger.size.api;
...
public interface MarketApi {
    ...
    ResponseEntity<List<OrderMarker>> marketOrderidAreaidMarksGet(@ApiParam(value = "", required = true) @PathVariable("orderid") String orderid,
    ...
    ResponseEntity<Void> marketOrderidAreaidMarksPost(@ApiParam(value = "", required = true) @PathVariable("orderid") String orderid,
    ...
    ResponseEntity<Void> marketOrderidAreaidMarksPut(@ApiParam(value = "", required = true) @PathVariable("orderid") String orderid,
                                                     @ApiParam(value = "", required = true) @PathVariable("areaid") Integer areaid,
    ...
    @RequestMapping(value = "/market/{orderid}/areas",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<Void> marketOrderidAreasPost(@ApiParam(value = "", required = true) @PathVariable("orderid") String orderid,
    ...
    @RequestMapping(value = "/market/{orderid}/areas",
        produces = { "application/json" }, 
        method = RequestMethod.PUT)
    ResponseEntity<Void> marketOrderidAreasPut(@ApiParam(value = "", required = true) @PathVariable("orderid") String orderid,
    ...
    ResponseEntity<Void> marketOrderidOrderFieldFieldIdDelete(@ApiParam(value = "", required = true) @PathVariable("orderid") String orderid,
    ...
    @RequestMapping(value = "/market/{orderid}/orderField",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<Void> marketOrderidOrderFieldPost(@ApiParam(value = "", required = true) @PathVariable("orderid") String orderid,
                                                     @ApiParam(value = "", required = true) @RequestBody String fieldId) throws Exception;
